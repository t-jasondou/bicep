...
{
    public class GraphResourceTypeProvider : IResourceTypeProvider
    {
        ...
        private readonly GraphResourceTypeLoader resourceTypeLoader;
        ...
        public GraphResourceTypeProvider(GraphResourceTypeLoader resourceTypeLoader)
        {
